...
def _m_length_raw(string, repl_text=''):
    ...
    if retain_nulls:
        ...
        # The standard behavior
        return _m_length_re.sub(repl_text, string).encode('utf-8')
...
def unpack_data_from_stream(hdr, f, elements='all', endian='@', fstart=None,
    ...
    if elements == 'all':
        ...
        trim = True
    # TODO if using this as a generator, should we trim??? mds
