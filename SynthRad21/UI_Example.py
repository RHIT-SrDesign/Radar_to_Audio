...
image_col = [
    [sg.Text(text=CFA[CFState][0], text_color=CFA[CFState][1], key='INDICATOR1'), sg.Text(text=PRIA[PRIState][0], text_color=CFA[CFState][1], key='INDICATOR2'),sg.Text(text=PWA[PWState][0], text_color=CFA[CFState][1], key='INDICATOR3')],
